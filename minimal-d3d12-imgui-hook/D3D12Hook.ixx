...
namespace D3D12
{
	...
	LRESULT APIENTRY WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) {
		if (g_Initialized && g_PluginManager && g_PluginManager->IsInitialized())
		{
			ImGuiIO& io = ImGui::GetIO();
